...
```{r}
#| echo: false
#| label: tbl-ivory_coast_timeline
#| tbl-cap: "Côte d'Ivoire's match by match results across AFCON"

readRDS("ivory_coast_timeline.rds") |> knitr::kable()
...
```{r}
#| label: manager-comparison-shotmap
#| fig-cap: "Comparison Between The Two Managers' Shot Maps"
#| echo: false
#| fig-width: 10
#| fig-height: 4
...
```{r}
#| label: shot-quality-vs-quantity
#| tbl-cap: "Shot Quality vs Quantity Comparison by Manager"
#| echo: false
readRDS("shotquality_vs_quantity.rds") |> knitr::kable()
```
...
```{r}
#| label: ivorycoast-managers-shotsconceded-xgagainst
#| tbl-cap: "Ivory Coast Shots Conceded and xG Against Table"
#| echo: false
readRDS("ivorycoast_managers_shotsconceded_xgagainst.rds") |> knitr::kable()
```
...
```{r}
#| label: defensive-actions-manager-comparison
#| tbl-cap: "Defensive Actions between Managers"
#| cho: false
readRDS("defensive_actions_manager_comparison") |> knitr::kable()
```
...
```{r}
#| label: passing_heatmap
#| fig-cap: "Passing Heatmap Comparison By Managaer"
#| echo: false
#| fig-width: 10
#| fig-height: 4
...
```{r}
#| label: dribble-manager-comparison-plot
#| fig-cap: "Dribble Heatmap Comparison By Manager"
#| echo: false
#| fig-width: 10
#| fig-height: 4
...
```{r}
#| label: final-shotmap
#| fig-cap: "Top 5 Shooters' Heatmap for Ivory Coast"
#| echo: false
#| fig-width: 10
#| fig-height: 4
...
```{r}
#| labels: fig-combined-goals-and-assists
#| tbl-cap: "Combined Goals and Assists Table"
#| echo: false
readRDS("combined_goals_and_assists.rds") |> knitr::kable()
...
#| fig-cap: "Heatmap of Top 5 dribblers for Ivory Coast"
#| echo: false
#| fig-width: 10
#| fig-height: 4
...
#| tbl-cap: "Ivory Coast Defensive stats by players"
#| echo: false
readRDS("defensive_stats.rds") |> knitr::kable()
...
```{r}
#| label: top5-passers-heatmap
#| fig-cap: "Heatmap of Passing Areas for Ivory Coast"
#| echo: false
#| fig-width: 10
#| fig-height: 4
...
```{r}
#| label: attacking-metrics
#| tbl-cap: "Ivory Coast Attacking Metrics"
#| echo: false
readRDS("attacking_metrics.rds") |> knitr::kable()
