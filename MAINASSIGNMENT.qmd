...
Figure 3 compares heat maps of passes under each manager.
...
This attacking data table highlights that Seko Fofana is one of the most influential offensive players. He ranks highly in four out of the 6 metrics, with only progressive passing and box entries being his weak points. Simon Adingra and Oumar Diakaté both played major roles in attacks, with high amounts of in all metrics apart from progressive passes which indicates that they are always on the receiving end of progressive passes.
