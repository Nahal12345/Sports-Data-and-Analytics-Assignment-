...
readRDS("app/ivory_coast_timeline.rds") |> knitr::kable()
...
#| fig-width: 10
#| fig-height: 4
readRDS("app/cuumulative_ivorycoast_xgplot.rds")
```
...
#| fig-width: 10
#| fig-height: 4
readRDS("app/manager_comparison_shotmap.rds")
```
...
#| echo: false
readRDS("app/shotquality_vs_quantity.rds") |> knitr::kable()
```
...
#| echo: false
readRDS("app/ivorycoast_managers_shotsconceded_xgagainst.rds") |> knitr::kable()
```
...
#| fig-width: 10
#| fig-height: 4
readRDS("app/passing_heatmap.rds")
```
...
#| fig-width: 10
#| fig-height: 4
readRDS("app/dribble_manager_comparison_plot.rds")
```
...
#| echo: false
readRDS("app/combined_goals_and_assists.rds") |> knitr::kable()
...
readRDS("app/top5_dribble_heatmap.rds")
```
...
#| echo: false
readRDS("app/defensive_stats.rds") |> head(5) |> knitr::kable()
...
#| fig-width: 10
#| fig-height: 4
readRDS("app/top5_passers_heatmap.rds")
...
#| echo: false
readRDS("app/attacking_metrics.rds") |> head(5) |> knitr::kable()
...
#| echo: false
readRDS("app/deserved_winner_tournament.rds") |> head(5) |> knitr::kable()
```
